...
struct vec2 {
	...
	float operator*(const vec2 &v) { return x * v.x + y * v.y; }
...
struct vec4 {
	...
	float operator*(const vec4 &v) { return x * v.x + y * v.y + z * v.z + w * v.w; }
...
struct mat4 {
	...
	void reflect(const vec4 &v) {
		...
		float y2 = y * 2.0f;
		float z2 = z * 2.0f;
		mat[0] = 1.0f - x * x2; mat[4] = -y * x2; mat[8] = -z * x2; mat[12] = -v.w * x2;
		mat[1] = -x * y2; mat[5] = 1.0f - y * y2; mat[9] = -z * y2; mat[13] = -v.w * y2;
		mat[2] = -x * z2; mat[6] = -y * z2; mat[10] = 1.0f - z * z2; mat[14] = -v.w * z2;
